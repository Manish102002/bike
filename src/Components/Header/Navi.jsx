  ...
  return (
    <>
      <div
        ...
        className=" flex z-50 text-center items-center justify-between lg:px-12 md:px-10  px-6  sm:px-10  text-textColor sticky top-0  bg-darkBlack h-[72px]
            shadow-lg transition duration-200 ease-in shadow-white/50  "
      >
        <Link to="/">
          <div>
            <img
              src="https://i.ibb.co/GPRRj3V/preloader.jpg"
              alt=""
              className="heading w-10 rounded-[50%]"
            />
          </div>
        </Link>
        <div className=" lg:translate-x-28 translate-x-5  md:hidden lg:block sm:block block">
          <div>
            <h1 className=" heading head font-bold text-[20px]  text-darkYellow  lg:text-[30px] md:text-[25px] sm:text-[20px]">
              Beni Automotives
            </h1>
          </div>
        </div>
            ...
            <div className=" flex items-center gap-4  justify-items-end">
              ...
              <Link to="/prebook">
                <div className=" cursor-pointer">
                  <h2 className=" heading py-2 text-sm font-[200] px-4 bg-bgDarkYellow hover:bg-lightYellow rounded-[2rem] text-black">
                    Pre-Book
                  </h2>
                </div>
              </Link>
        ...
        <div
          onClick={toggleMenu}
          className={`flex flex-col gap-1  cursor-pointer lg:hidden md:hidden `}
        >
          <div
            className={`w-7 h-[3px] text-white bg-white border border-r-2 transition duration-300 ease   ${
              open
                ? " transform translate-y-[4px] -rotate-[45deg]"
                : "bg-blue-300"
            }`}
          ></div>

          <div
            className={`w-7 h-[3px] text-white bg-white border border-r-2  ${
              open ? "hidden" : "bg-blue-300"
            }`}
          ></div>
